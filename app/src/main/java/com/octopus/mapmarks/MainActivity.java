...
public class MainActivity extends AppCompatActivity implements AMap.OnMyLocationChangeListener {
    ...
    private ArrayList<MLatLonPoint> mubiaolist = new ArrayList<MLatLonPoint>();
    ...
    private void testCar() {
        ...
        for (int i = 0; i < mubiaolist.size(); i++) {
            ...
            int mode = RouteSearch.DrivingDefault; //路径规划的策略，可选，默认为0-速度优先 参见 ：https://developer.amap.com/api/android-sdk/guide/route-plan/drive/#t6
...
//        myLocationStyle.myLocationType(MyLocationStyle.LOCATION_TYPE_MAP_ROTATE_NO_CENTER);//连续定位、蓝点不会移动到地图中心点，地图依照设备方向旋转，并且蓝点会跟随设备移动。
    ...
    class CARRouteSearchListener implements RouteSearch.OnRouteSearchListener {
        ...
        public void onDriveRouteSearched(DriveRouteResult result, int errorCode) {
            ...
            handDriveRouteSearched(result, errorCode);
